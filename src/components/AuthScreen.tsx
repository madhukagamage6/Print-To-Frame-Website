...
export default function AuthScreen({ onGoogleSignIn, isLoggingIn, errorMessage }: AuthScreenProps) {
  ...
  return (
    <div className="max-w-md mx-auto text-center py-10 md:py-20 relative z-10">
      ...
      >
        <div className="w-16 h-16 rounded-2xl bg-surface-container-high border border-primary-container/20 flex items-center justify-center mx-auto mb-6 shadow-[0_0_20px_rgba(0,218,243,0.15)]">
          <img 
            src="https://drive.google.com/uc?export=view&id=1JhI1uYBGhpDOREzCj-Xau-Tdom0VfNQn" 
            alt="Print2Frame Icon" 
        ...
        {mode === 'signin' && (
          <div className="mt-8 pt-6 border-t border-outline-variant/20">
            ...
            <button 
              ...
              className="gsi-material-button w-full flex items-center justify-center font-mono tracking-wide shadow-[0_0_15px_rgba(0,218,243,0.1)] hover:shadow-[0_0_20px_rgba(0,218,243,0.25)] hover:scale-[1.02] transition-all bg-surface-container-high"
            >
              {isLoggingIn ? (
                ...
                <div className="gsi-material-button-state flex items-center gap-3">
                  <div className="gsi-material-button-icon bg-white p-1 rounded-sm my-1">
                  ...
                  <span className="gsi-material-button-contents font-sans text-sm font-medium">Sign in with Google</span>
                </div>
              )}
            </button>
          </div>
